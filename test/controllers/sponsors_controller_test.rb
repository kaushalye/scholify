...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { email: @sponsor.email, first_name: @sponsor.first_name, last_name: @sponsor.last_name, phone: @sponsor.phone, title: @sponsor.title }
    end
  ...
  test "should update sponsor" do
    patch :update, id: @sponsor, sponsor: { email: @sponsor.email, first_name: @sponsor.first_name, last_name: @sponsor.last_name, phone: @sponsor.phone, title: @sponsor.title }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
