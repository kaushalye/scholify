...
class ScholarshipsControllerTest < ActionController::TestCase
  ...
  test "should create scholarship" do
    assert_difference('Scholarship.count') do
      post :create, scholarship: { amount: @scholarship.amount, end_date: @scholarship.end_date, sponsor: @scholarship.sponsor, start_date: @scholarship.start_date, status: @scholarship.status, student: @scholarship.student }
    end
  ...
  test "should update scholarship" do
    patch :update, id: @scholarship, scholarship: { amount: @scholarship.amount, end_date: @scholarship.end_date, sponsor: @scholarship.sponsor, start_date: @scholarship.start_date, status: @scholarship.status, student: @scholarship.student }
    assert_redirected_to scholarship_path(assigns(:scholarship))
  end
