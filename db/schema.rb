...
ActiveRecord::Schema.define(version: 20161012121855) do
  ...
  add_index "donations", ["scholarship_id"], name: "index_donations_on_scholarship_id"
  add_index "donations", ["sponsor_id"], name: "index_donations_on_sponsor_id"
  ...
  add_index "payments", ["bulk_transaction_id"], name: "index_payments_on_bulk_transaction_id"
  add_index "payments", ["scholarship_id"], name: "index_payments_on_scholarship_id"
